<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('galeri.index', [], false) ? url('/admin/galeri') : '#'" :active="request()->is('admin/galeri*')">
                        {{ __('Kelola Galeri') }}
                    </x-nav-link>
                    <x-nav-link :href="url('/admin/guru')" :active="request()->is('admin/guru*')">
                        {{ __('Kelola Guru & Staff') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('galeri.index', [], false) ? url('/admin/galeri') : '#'" :active="request()->is('admin/galeri*')">
                {{ __('Kelola Galeri') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="url('/admin/guru')" :active="request()->is('admin/guru*')">
                {{ __('Kelola Guru & Staff') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link href="/pengumuman" :active="request()->is('pengumuman')">
                {{ __('Lihat Pengumuman') }}
            </x-responsive-nav-link>
